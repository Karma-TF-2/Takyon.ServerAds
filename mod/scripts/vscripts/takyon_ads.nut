...
void function AdInit(){
    ...
    Ad ad1
    ad1.message = format("%s[Karma]%s Welcome to Karma Kraber9k! This is a high air acceleration, kraber only server.", "\x1b[38;2;220;220;0m", "\x1b[38;2;0;135;220m")
    ad1.tags = ["trigger", "start"]
    sa_ads.append(ad1)
    
    // example of ad that triggers wen a client connects but can also trigger in the usual loop of ads
    Ad ad2
    ad2.message = format("%s[Karma]%s Cheater? Troublemaker? Bug Report? Make a ticket in our Discord at discord.gg/karmagaming", "\x1b[38;2;220;220;0m", "\x1b[38;2;0;135;220m")
    ad2.tags = ["connected"]
    sa_ads.append(ad2)
    
    // example of ad that triggers on kill but can also trigger in the usual loop of ads
    Ad ad3 
    ad3.message = format("%s[Karma]%s Want a tutorial? Join our Discord at karma-gaming.net/go/kraber9k to find Slimeafro's video.", "\x1b[38;2;220;220;0m", "\x1b[38;2;0;135;220m")
    ad3.tags = ["kill"]
    sa_ads.append(ad3)
    
    // example of ad with color
    Ad ad4
    ad4.message = format("%s[Karma]%s To vote to skip the map, type !rtv or !skip in chat.", "\x1b[38;2;220;220;0m", "\x1b[38;2;0;135;220m")
    ad4.priority = 1
    sa_ads.append(ad4)
